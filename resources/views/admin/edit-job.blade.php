@extends('layouts.home',['title'=>'Edit Job'])
                ...
                <div class="card-body">
                    ...
                    <form class="user-form" method="POST" action="/jobs/{{$job->id}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" {{ $errors->has('description') ? 'alert-danger' : '' }} name="description" rows="6" value="{{ $job->description}}" placeholder="Description" required> {{$job->description}}
                            </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="ui fluid search selection dropdown" name="vehicle_id" id="search-select2" aria-placeholder="Vehicle">
                        ...
                        <div class="form-group">
                            ...
                            <input type="location" class="form-control" name="location" {{ $errors->has('location') ? 'alert-danger' : '' }} placeholder="Location" value="{{ $job->location }}" required>
                        ...
                        <div class="input-group mb-2 mr-sm-2">
                                ...
                                <div class="input-group-text text-primary">
                                    <div class="form-check form-check-success">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" name="job_done" id="done" value="1"> Mark Job as
                            ...
                            <textarea class="form-control" name="remarks" rows="6" placeholder="Finished remarks"> </textarea>
                        </div>
